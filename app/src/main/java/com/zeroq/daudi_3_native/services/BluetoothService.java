package com.zeroq.daudi_3_native.services;
    ...
    private class AcceptThread extends Thread {
                        ...
                        switch (BluetoothService.this.mState) {
                            ...
                            case 3:
                                try {
                                    ...
                                    Timber.e(var4, "Could not close unwanted socket");
                                }
                                break;
                            case 1:
                            case 2:
        ...
        public void cancel() {
            ...
            try {
                ...
                Timber.e(var2, "close() of server failed");
            }
